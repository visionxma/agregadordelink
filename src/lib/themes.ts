...
export const themePresets: ThemePreset[] = [
  ...
  },
  {
    id: "img-gym",
    name: "Academia",
    vibe: "força · motivação",
    theme: {
      preset: "img-gym",
      background: {
        type: "image",
        url: "https://images.unsplash.com/photo-1534438327077-1af4ffe9c60f?auto=format&fit=crop&w=1200&q=80",
  ...
  },
  {
    id: "img-wedding",
    name: "Casamento",
    vibe: "romântico · floral",
    theme: {
      preset: "img-wedding",
      background: {
        type: "image",
        url: "https://images.unsplash.com/photo-1519225421980-716cf45eda24?auto=format&fit=crop&w=1200&q=80",
        overlay: "rgba(255,240,245,0.35)",
      },
      foreground: "#3b0764",
